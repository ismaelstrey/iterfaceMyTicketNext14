  ...
  return (
    <div className="bg-menu">
      <div className="flex w-full h-screen bg-sub-menu border-solid border-r-2 rounded-tl-3xl flex-col">
        <div
          className={`flex w-60 h-20  content-center items-center justify-around transition-all duration-500 ${navigate ? "-ml-60" : " border-solid border-b-2"
            }`}
        >
          ...
          <span
            ...
            className={`-mr-9 rounded-full z-20 bg-sub-menu p-0 cursor-pointer ${navigate ? "rotate-180 text-white" : "text-[var(--main)]"
              }`}
          >
        ...
        <div
          className={`flex min-h-[80%] flex-col center justify-center itens-center content-center duration-700 transition-opacity  ${navigate && "hidden"
            }`}
        >
