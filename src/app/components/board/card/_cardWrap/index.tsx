...
const CardWrap = ({ children, id, type, prioridade }: CardWrapProps) => {
    return (
        <div className='flex m-2 w-80 h-max-[15rem] bg-sub-menu rounded-md md:w-80' draggable onDragStart={(e) => drag(e, 'teste')} accessKey={String(id)} aria-description={type} data-id={id} >
